...
(1, 'Iron Man', 'https://www.marvel.com/characters/iron-man-tony-stark', 'Iron Man, also known as Tony Stark, possesses genius-level intellect and expertise in engineering and technology. He is equipped with a powered exoskeleton suit and various technological gadgets, including repulsor rays and flight capabilities.'),
(2, 'Captain America', 'https://www.marvel.com/characters/captain-america-steve-rogers', 'Captain America, also known as Steve Rogers, is a super-soldier with enhanced strength, agility, and endurance. He wields a vibranium shield with exceptional defensive capabilities.'),
(3, 'Thor', 'https://www.marvel.com/characters/thor', 'Thor is the Norse God of Thunder who possesses superhuman strength, durability, and the ability to control lightning. He wields the enchanted hammer Mjolnir, which grants him flight and the ability to manipulate weather.');
